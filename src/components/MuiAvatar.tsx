  ...
  return (
    <Stack spacing={4}>
        <Stack spacing={1} direction='row'>
            ...
            <Avatar variant='square' sx={{bgcolor: 'secondary.light', width:'48px', height:'48px'}}>snj</Avatar>
            <Avatar variant='rounded' sx={{bgcolor: 'secondary.light', width:'48px', height:'48px'}}>snj</Avatar>
        </Stack>
    </Stack>
  )
}
